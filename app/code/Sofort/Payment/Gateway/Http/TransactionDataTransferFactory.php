...
/**
 * Class TransactionDataTransferFactory
 * @package Sofort\Payment\Gateway\Http
 */
class TransactionDataTransferFactory implements \Magento\Payment\Gateway\Http\TransferFactoryInterface
{
    /**
     * @var TransferBuilder
     */
    ...
    /**
     * TransactionDataTransferFactory constructor.
    ...
    public function create(array $request)
    {
         ...
         */
        $requestXmlData = $this->_array2XmlHelper->createXML('transaction_request', $request);
        $requestXml = $requestXmlData->saveXml();
        $requestXml = str_replace('<transaction_request>', '<transaction_request version="2">', $requestXml);
        ...
        return $this->_transferBuilder
            ...
            ->setHeaders(
                [
                    'User-Agent: SofortLib-php/'
                    .$this->_paymentHelperVersion->getModuleSignature()
                    .'-'
                    .\Zend_Http_Client::POST,
                    'Content-Type: application/xml; charset=UTF-8',
                    'Accept: application/xml; charset=UTF-8',
                    'Authorization: Basic '
                    .base64_encode($this->_configHelper->getCustomerId().':'.$this->_configHelper->getApiKey())
                ]
            )
